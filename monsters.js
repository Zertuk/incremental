...
function Monster() {
	...
	this.loot = function() {
		...
		gainedLoot = Math.floor(lootDropped*this.monsterMoney*player.freedom*2.5 + gainedLoot);
...
rocketScientist.monsterMoney = 6.5;
